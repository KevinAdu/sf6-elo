...
import { calculateWinProbability, calculateBO3Probability, calculateBO5Probability, formatPercent } from '../utils/eloProbabilities';
...
export default function EloWinProbabilityCalculator() {
  ...
  return (<div className="elo-calculator">
